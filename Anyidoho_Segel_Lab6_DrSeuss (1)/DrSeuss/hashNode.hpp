...
class hashNode {
    ...
    string keyword; // this is used as the key â€“ each key is only inserted once!
...
public:
    hashNode(); //construor-initializes keyword to â€œâ€� , values to 0, and array to NULL
    ...
    //increases currSize, checks to make sure thereâ€™s more space, and, if not, calls
        //dblArray();
    ...
    //thereâ€™s no values in the value array, then it returns an empty string.
};
#endif /* HASHNODE_HPP_ */
